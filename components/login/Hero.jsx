...
<section className="lp:pb-39! pt-28 pb-20 md:pt-39 md:pb-28">
  <div className="main-container">
    <div className="space-y-19">
      <div className="space-y-3 text-center">
        ...
        >
          Let’s explore how Urbanland can support your goals with AI-driven solutions.
        </p>
      </div>
      ...
      >
        ...
        >
          <form action="#" className="w-full">
            ...
            {/* submit button */}
            <div className="mt-8">
              <div style={{ display: 'contents' }} dangerouslySetInnerHTML={{ __html: `<button type="submit" class="w-full" aria-label="Login">
  <div
  ...
  >
    <span class="shrink-0 first-letter:uppercase"> Login </span>
...
` }} />
            ...
            <fieldset className="mt-6 flex items-center justify-between gap-x-5">
              ...
              <div>
                <a
                  href="#"
                  className="text-tagline-3 text-background-13/60 font-inter-tight block flex-1 font-normal underline underline-offset-2"
                  >Forgot password?</a
                >
              </div>
            </fieldset>
...
` }} />
        ...
        <figure
          ...
          data-offset="100"
          className="h-[400px] w-full overflow-hidden rounded-2xl md:h-[599px] lg:max-w-[557px]"
        >
          <img src="./images/opai-img-471.jpg" alt="login-hero" className="size-full object-cover" />
        </figure>
      </div>
    </div>
  </div>
