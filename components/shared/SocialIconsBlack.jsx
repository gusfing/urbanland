...
<ul className="flex items-center gap-3">
  <li>
    <a href="#" className="inline-block transition-transform duration-500 hover:-translate-y-1">
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M7 11.5H13" stroke="#0D0D12" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </a>
  </li>
  <li>
    ...
    <a href="#" className="inline-block transition-transform duration-500 hover:-translate-y-1">
      ...
      >
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M8.25 7.5V13.5" stroke="#0D0D12" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M5.25 7.5V13.5" stroke="#0D0D12" strokeLinecap="round" strokeLinejoin="round" />
        <path
