    ...
    <a href="#" className="inline-block transition-transform duration-500 hover:-translate-y-1">
      ...
      >
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M8.25 7.5V13.5" stroke="#CED7DE" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M5.25 7.5V13.5" stroke="#CED7DE" strokeLinecap="round" strokeLinejoin="round" />
        <path
